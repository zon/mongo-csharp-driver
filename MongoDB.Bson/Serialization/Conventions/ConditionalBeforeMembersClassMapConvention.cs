...
namespace MongoDB.Bson.Serialization.Conventions
{
    ...
    /// </summary>
    public abstract class ConditionalBeforeMembersBsonClassMapConvention : IBeforeMembersBsonClassMapConvention
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="classMap">The class map.</param>
        void IBeforeMembersBsonClassMapConvention.Apply(BsonClassMap classMap)
        {
            if (!Matches(classMap))
            {
                return;
