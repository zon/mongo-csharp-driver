...
namespace MongoDB.BsonUnitTests.Serialization.Serializers
{
    ...
    public class BsonDocumentWrapperSerializerTests
    {
        ...
        public void TestEmpty()
        {
            ...
            {
                var expectedMessage = "An error occurred while deserializing the V property of class MongoDB.BsonUnitTests.Serialization.Serializers.BsonDocumentWrapperSerializerTests+TestClass";
